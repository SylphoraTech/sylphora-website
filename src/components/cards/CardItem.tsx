...
>
  <svg
    ...
    className="h-4 w-4 text-blue-400 mt-1 flex-shrink-0 transition-all duration-300 group-hover/item:text-blue-300 group-hover/item:scale-110"
    viewBox="0 0 20 20"
    fill="currentColor"
  >
    <path
  ...
  <span className="text-sm text-gray-100 leading-snug group-hover/item:text-white transition-colors duration-300">
    {point}
  </span>
</motion.li>
