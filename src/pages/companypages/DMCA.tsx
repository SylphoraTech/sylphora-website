...
const DMCA = () => {
  return (
    <div className="container mx-auto p-6">
      ...
      <p className="mt-4">
        Sylphora Technologies Private Limited respects the intellectual property rights of others
        and expects users of our services to do the same. In accordance with the Digital Millennium
        Copyright Act (DMCA), we will respond promptly to claims of copyright infringement committed
        using our services.
      </p>
      ...
      <p className="mt-6">
        <strong>DMCA Agent Contact Information:</strong>
      </p>
      <p>
        📧 Email:{" "}
