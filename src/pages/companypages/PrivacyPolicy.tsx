...
const PrivacyPolicy = () => {
  return (
    <div className="container mx-auto p-6">
      ...
      <p className="text-center"><strong>Last Updated:</strong> March 10, 2025</p>
      ...
      <div className="mt-6">
        ...
        <p>The words with capitalized initial letters have specific meanings defined under the following conditions. These definitions apply whether words appear in singular or plural.</p>

        <h3 className="text-xl font-semibold mt-4">Definitions</h3>
        <ul className="list-inside list-disc mt-4">
          <li><strong>Account:</strong> A unique account created for You to access our Service.</li>
          <li><strong>Affiliate:</strong> An entity that controls, is controlled by, or is under common control with Us.</li>
          <li><strong>Company:</strong> Sylphora Technologies Private Limited, Mumbai.</li>
          <li><strong>Cookies:</strong> Small files stored on Your Device containing browsing history details.</li>
          ...
          <li><strong>Usage Data:</strong> Data collected automatically through the Service.</li>
          <li><strong>Website:</strong> <a href="http://www.sylphora.com" target="_blank" rel="noopener noreferrer">Sylphora</a></li>
        ...
        <p>Usage Data is collected automatically and may include IP address, browser type, pages visited, time spent on pages, and device details.</p>
        ...
        <p>We will retain Your Personal Data only as necessary to comply with legal obligations, resolve disputes, and enforce agreements.</p>

        <h3 className="text-xl font-semibold mt-6">Transfer of Your Personal Data</h3>
        <p>Your data may be processed outside of Your location, subject to secure handling measures.</p>
        ...
        <ul className="list-inside list-disc mt-2">
          <li><strong>Business Transactions:</strong> In case of a merger or sale.</li>
        ...
        <ul className="list-inside list-disc mt-2">
          <li>Email: <a href="mailto:sylphora.pvt@gmail.com" className="text-blue-500">Sylphora.pvt@gmail.com</a></li>
        </ul>
      </div>
    </div>
  );
